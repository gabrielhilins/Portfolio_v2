...
export const softSkillsData: (Omit<SoftSkill, 'name' | 'proficiency'> & { nameKey: string; proficiencyKey: string })[] = [
  ...
  { nameKey: "skill_name_communication", icon: FaComments, proficiencyKey: "skill_proficiency_developed" },
  ...
  { nameKey: "skill_name_collaborative_work", icon: FaUsers, proficiencyKey: "skill_proficiency_developed" },
